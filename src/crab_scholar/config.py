"""Configuration management for CrabScholar using pydantic-settings.
...
class CrabConfig(BaseSettings):
    """Configuration settings for CrabScholar.

    Settings are loaded from:
    1. Environment variables (with CRAB_ prefix)
