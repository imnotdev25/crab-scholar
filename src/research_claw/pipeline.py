"""Pipeline orchestration — library API for ResearchClaw.
...
from research_claw.analyze.analyzer import analyze_all
from research_claw.analyze.dimensions import load_dimensions
from research_claw.config import RClawConfig
from research_claw.export import export_graph
...
from research_claw.ingest.fetcher import fetch_paper_text, fetch_paper_text_from_path
from research_claw.ingest.scholar import ScholarClient
from research_claw.llm_client import LLMClient
from research_claw.models import Paper, PaperAnalysis

logger = logging.getLogger(__name__)


def _make_llm_client(config: RClawConfig) -> LLMClient:
...
def _resolve_input(query: str, config: RClawConfig) -> list[Paper]:
